...
import { createHistoryFileIfMissing, createJsonFileIfMissing, ensureRunStorage, managedJsonFileExists, readJson, resolveRunPaths } from '../../persistence/run-state.mjs';
...
async function ensureRunFiles(paths) {
  ...
  if (!batonExists) {
    ...
    await createJsonFileIfMissing(paths.batonPath, {
