...
export function next({ workflow, baton, renderSteps, includeDiagnostics = false, initialized, resumed }) {
  const rendered = renderWorkflow({ workflow, baton, renderSteps, includeDiagnostics });
  return {
    rendered,
