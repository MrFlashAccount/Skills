...
const outDir = path.join(root, 'develop/dist/validators');
rmSync(outDir, { recursive: true, force: true });
mkdirSync(outDir, { recursive: true });

const schemas = [
  ['baton.mjs', 'develop/schemas/baton.json'],
  ['workflow.mjs', 'develop/schemas/workflow.json'],
  ['worker-output.mjs', 'develop/schemas/worker-output.json'],
  ['workflow-interpreter-response.mjs', 'develop/schemas/workflow-interpreter-response.json'],
];
...
console.log(`generated ${schemas.length} standalone validators in develop/dist/validators`);
