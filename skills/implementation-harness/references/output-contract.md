...
- `verification_results`: commands/checks run, results, notable gaps, and whether each delegated implementer satisfied the loaded role material's final-answer requirements, or the `blocked` state if required role material could not be used.
