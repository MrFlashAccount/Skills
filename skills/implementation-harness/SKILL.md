...
- A role label alone is not a role contract. Each implementer prompt must include the shared delegated role task template from [../../shared/delegate/delegated-role-task-template.md](../../shared/delegate/delegated-role-task-template.md) plus the selected phase overlay from [../dev-harness/references/roles/implementers.md](../dev-harness/references/roles/implementers.md).
