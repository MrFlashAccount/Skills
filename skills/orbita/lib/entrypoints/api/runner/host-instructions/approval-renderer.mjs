...
export function renderApprovalInstruction({ step, request, commands = {} } = {}) {
  return renderApprovalInstructionProjection(
    buildApprovalInstructionProjection({ step, request, commands }),
  );
}
