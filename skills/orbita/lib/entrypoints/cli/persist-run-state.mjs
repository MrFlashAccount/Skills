...
function parseCliArgs(argv) {
  try {
    ...
    fail(`${error.message}\nusage: node skills/orbita/lib/entrypoints/cli/persist-run-state.mjs --run-id <id> [--workflow <workflow.json>] (--response <workflow-interpreter-response.json> | --baton <new-baton.json>) [--decision <text>] [--lease-token <token>]`);
  }
}
