...
const DEFAULT_USAGE = 'usage: node ./lib/entrypoints/cli/workflow-interpreter.mjs inspect <workflow.json> <baton.json> | render [--diagnostics] <workflow.json> <baton.json> | apply <workflow.json> <baton.json> <worker-output.json>';

const USAGE_BY_MODE = {
  inspect: 'usage: node ./lib/entrypoints/cli/workflow-interpreter.mjs inspect <workflow.json> <baton.json>',
  render: 'usage: node ./lib/entrypoints/cli/workflow-interpreter.mjs render [--diagnostics] <workflow.json> <baton.json>',
  apply: 'usage: node ./lib/entrypoints/cli/workflow-interpreter.mjs apply <workflow.json> <baton.json> <worker-output.json>',
};
