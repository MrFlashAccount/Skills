...
- Produce a structured Researcher packet with an attack pass and wrapper verdict.
...
- The output contract keeps the Researcher packet distinct from wrapper-level critic findings.
...
- with the skill: does it return a reusable structured Researcher packet, wrapper-level attack findings, and a clearly surfaced unresolved/blocking section when needed?
