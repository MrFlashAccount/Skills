...
- When creating or repairing design law without a chosen direction, did the workflow start from product basis before taste?
...
- reference rounds with near-duplicate options, one palette, or one nice option followed by canon
