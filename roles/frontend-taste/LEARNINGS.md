...
For new screen/design work inside an existing design law, run Reference Scout, produce 3-4 visual proposals, critique them as needed, let Sergey choose/combine/reject, then proceed to detail/spec/implementation support. This is role behavior inside design law, not the `create-design` process.
